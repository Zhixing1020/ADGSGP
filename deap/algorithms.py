...
def varSem(population, toolbox, tarSem, library):
    """Part of an evolutionary algorithm applying onl the variation part
    (crossover **and** mutation). The modified individuals have their
    fitness invalidated. The individuals are cloned so returned population is
    independent of the input population.
    ...
    :param toolbox: A :class:`~deap.base.Toolbox` that contains the evolution
                    operators.
    :param tarSem: The final output target semantic.
    :param library: The library storing all individuals.
    :returns: A list of varied individuals that are independent of their
              parents.
